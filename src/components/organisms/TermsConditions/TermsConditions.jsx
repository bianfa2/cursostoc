...
import TouchImage from "../../../assets/touch2.png";
    ...
    <div className="terms-conditions">
      ...
      <div className="content">
        <p>
          ...
          Cursos Toc usa y protege la información que es proporcionada por sus
          ...
          <span className="highlighter">Información que es recogida</span>{" "}
          <br />
          ...
          proporcione y podrán ser cancelados en cualquier momento.Cursos Toc
          ...
          <span className="highlighter">Cookies</span> <br />
      ...
      <div className="content">
        <p>
          ...
          <br /> <br />
          <span className="highlighter">Enlaces a Terceros</span> <br />
          ...
          requerido por un juez con un orden judicial.Cursos Toc Se reserva el
          derecho de cambiar los términos de la presente Política de Privacidad
          en cualquier momento.
          <br /> <br />
        </p>
        <img src={PointsImage} alt="" />
      </div>
    </div>
  );
};
